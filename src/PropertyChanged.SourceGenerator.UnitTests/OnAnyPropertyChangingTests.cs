...
public partial class Derived : Base
{
    ...
    private void OnAnyPropertyChanging(string name, object o) { }
        ...
        this.AssertThat(input, It.HasFile("Derived", rewriters).HasDiagnostics(
            // (11,18): Warning INPC034: The OnAnyPropertyChanging method has an 'oldValue' parameter, but the 'OnPropertyChanging' method defined in a base class does not. Please add this parameter to 'OnPropertyChanging'
            // OnAnyPropertyChanging
            Diagnostic("INPC034", @"OnAnyPropertyChanging").WithLocation(11, 18)
        ));
    }
...
public partial class SomeViewModel : INotifyPropertyChanging
{
    ...
    private void OnAnyPropertyChanging() { }
        ...
        this.AssertThat(input, It.HasDiagnostics(
            // (6,18): Warning INPC024: Found one or more OnAnyPropertyChanged methods, but none had the correct signature, or were inaccessible. Skipping
            // OnAnyPropertyChanging
            Diagnostic("INPC024", @"OnAnyPropertyChanging").WithLocation(6, 18)));
    }
...
public partial class Derived : Base
{
    ...
    private void OnAnyPropertyChanging(string name) { }
        ...
        this.AssertThat(input, It.HasDiagnostics(
            ...
            // (11,18): Warning INPC033: OnAnyPropertyChanging method will not be called because the method to raise PropertyChanging events 'OnPropertyChanging' cannot defined or overridden by the source generator
            // OnAnyPropertyChanging
            Diagnostic("INPC033", @"OnAnyPropertyChanging").WithLocation(11, 18)
        ));
    }
}
